...
class CustomUser(AbstractUser):
    ...
    CHILD = 'Child'
    DOCTOR = 'Doctor'
    HEALTHCARE_PROVIDER = 'Healthcare Provider'  # New role for healthcare providers
    ROLE_CHOICES = [
        (ADMIN, 'Admin'),
        (CHILD, 'Child'),
        (DOCTOR, 'Doctor'),
        (HEALTHCARE_PROVIDER, 'Healthcare Provider'),  # Add Healthcare Provider to role choices
    ]
